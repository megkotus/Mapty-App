...
class App {
  ...
  _loadMap(position) {
    ...
    console.log(this);
    this.#map = L.map('map').setView(coords, this.#mapZoomMethod);
  ...
  _moveToPopup(e) {
    //Attaching event handler to a not yet created property
    ...
    this.#map.setView(workout.coords, this.#mapZoomMethod, {
      animate: true,
      pan: {
        duration: 1,
      },
